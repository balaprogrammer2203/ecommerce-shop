...
type RawLink = { label: string; categorySlug: string; badge?: NavBadge };
type RawColumn = { title: string; links: RawLink[] };
type RawItem = { id: string; label: string; sortOrder: number; columns: RawColumn[] };

/** Keep in sync with `backend/utils/megaMenuSeed.js` */
const RAW: RawItem[] = [
  {
    id: 'men',
    label: 'Men',
    ...
    columns: [
      {
        ...
        links: [
          {
            label: 'Cookware',
            categorySlug: 'home-kitchen-kitchen-dining-cookware',
            badge: 'sale',
          },
          {
            label: 'Appliances',
            categorySlug: 'home-kitchen-kitchen-dining-appliances',
            badge: 'trending',
          },
      ...
      },
      {
        ...
        links: [
          {
            label: 'Lighting',
            categorySlug: 'home-kitchen-decor-furniture-lighting',
            badge: 'new',
          },
    ...
    columns: [
      ...
      },
      {
        ...
        links: [
          ...
          {
            label: 'Sun care',
            categorySlug: 'beauty-personal-care-skincare-sun-body',
            badge: 'sale',
          },
    ...
    columns: [
      {
        ...
        links: [
          ...
          {
            label: 'Cameras',
            categorySlug: 'electronics-mobiles-tablets-smartphones',
            badge: 'new',
          },
        ],
      },
      {
        ...
        links: [
          ...
          {
            label: 'Accessories',
            categorySlug: 'electronics-mobiles-tablets-accessories',
            badge: 'sale',
          },
        ],
      },
...
export const FALLBACK_MEGA_MENU_ITEMS: MyntraNavItem[] = RAW.map((item) => ({
  id: item.id,
  label: item.label,
